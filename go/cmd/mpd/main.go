...
func main() {
	...
	root.Flags().StringVar(&f.serviceStart, "service-start", "",
		"Start an extra service `name` (mailpit, adminer, selenium, authentik, zitadel) and keep it autostarting. A project's MPD_REQUIRE_SERVICES starts what it needs on its own.")
