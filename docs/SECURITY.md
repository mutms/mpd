...
| Services    | `<NNN>.mpd.test` (the VM's zone apex)                          | data volume `/srv/meta/`                     | Regenerated by `--setup` when CA changes |
