...
#
# Seeds /srv/projects/<project>/ from this type's template/ directory
# (mpd.env) and adds every template/ path to .git/info/exclude. Both are
# apply_project_template's job; `mpd start` calls it again so a file added
